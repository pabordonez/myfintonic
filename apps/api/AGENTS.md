...
5.  **Variables**: Deben ser verbose, tiene que tener nombres claros intentando huir de nombres de
...
Implementar mejoras de owasp, apoyarte en cors, helmet, zod, swagger
