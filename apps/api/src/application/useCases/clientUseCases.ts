...
export class ClientUseCases {
  ...
  async getClientById(id: string) {
    ...
    async changePassword(targetUserId: string, newPassword: string, currentPassword?: string, requestorRole?: string, requestorId?: string): Promise<void> {
    // 1. Security Check
    ...
    await this.clientRepository.update(targetUserId, { password: hashedPassword })
  }
}