  ...
  async create(dto: CreateClientFinancialEntityDto): Promise<IClientFinancialEntity> {
    try {
      ...
      const data: any = {
        ...
        balance: (dto.balance !== null && dto.balance !== undefined) ? dto.balance : null,
        initialBalance: (dto.initialBalance !== null && dto.initialBalance !== undefined) ? dto.initialBalance : ((dto.balance !== null && dto.balance !== undefined) ? dto.balance : null),
      };
