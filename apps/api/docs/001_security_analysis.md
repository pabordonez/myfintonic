...
- **Separación de Entornos**: Uso de _Multi-stage builds_ en Dockerfile para separar dependencias de desarrollo y producción (`npm prune --production`), evitando que herramientas de dev lleguen a la imagen final.
