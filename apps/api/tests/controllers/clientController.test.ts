...
describe('ClientController', () => {
  ...
  describe('register', () => {
    ...
    it('should return 400 if registration fails generically', async () => {
      vi.mocked((useCases.register = vi.fn())).mockRejectedValue(
  ...
  describe('getById', () => {
    ...
    it('should allow access if user is accessing their own profile', async () => {
      ...
      vi.mocked((useCases.getClientById = vi.fn())).mockResolvedValue(
        mockClient as any
      )
  ...
  describe('update', () => {
    ...
    it('should update client data successfully if user is owner', async () => {
      ...
      vi.mocked((useCases.updateClient = vi.fn())).mockResolvedValue(
        updatedClient
      )
