...
Crear una aplicación web para el seguimiento de finanzas personales: fondos indexados, depósitos a plazo fijo, robot-advisor, acciones y cuentas corrientes.

Backend

Utilizando **Node.js + TypeScript** como backend, lista para poner en producción con **Docker** y futura integración con **CI/CD**.
