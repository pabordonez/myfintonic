...
CREATE TABLE IF NOT EXISTS `FinancialProduct` (
    ...
    `financialEntity` VARCHAR(191) NOT NULL,
...
-- Tabla de Transacciones (para Cuentas Corrientes)
CREATE TABLE IF NOT EXISTS `Transaction` (
    ...
    CONSTRAINT `fk_transaction_product` FOREIGN KEY (`productId`) REFERENCES `FinancialProduct`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
